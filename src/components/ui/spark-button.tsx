...
import { ElementType, ComponentPropsWithoutRef, type ReactNode } from "react";
...
const CosmicGlowButton = <T extends ElementType = "button">({
  ...
  return (
    ...
    >
      <span
        className="absolute inset-0 z-0 rounded-2xl opacity-40 blur-lg animate-glow-scale"
        style={{
      ...
      />
      <span
        className="absolute inset-0 z-0 rounded-2xl opacity-20 animate-glow-slide"
        style={{
