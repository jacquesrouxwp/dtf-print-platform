    ...
    <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2 print:hidden">
      {links.map((link) => (
        <a
          ...
          title={link.label}
          className="group flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-neutral-950/85 text-foreground shadow-lg backdrop-blur transition hover:border-accent hover:text-accent"
        >
